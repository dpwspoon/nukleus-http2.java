...
public final class ClientStreamFactory implements StreamFactory
{
            ...
            final MessageConsumer networkThrottle)
    {
        ...
        if (route != null)
        {
            ...
            newStream = new ClientAcceptStream(networkThrottle, networkId)::handleStream;
        }
    ...
    private final class ClientAcceptStream
    {
                ...
                BeginFW begin)
        {
            ...
            http2Connection = new Http2Connection(ClientStreamFactory.this, router, networkReplyId,
